...
I’m an Open Source Software project contributor on projects like Microsoft’s [TypeScript compiler in Go](https://github.com/superaffectivejosh/typescript-go), Meta / Facebook’s [React](https://github.com/superaffectivejosh/react), and [Speedy Web Compiler](https://github.com/superaffectivejosh/swc), the JavaScript compiler behind Vercel’s Next.js. While I haven’t made pull requests to these projects yet, I plan to submit code updates using Anthropic’s [Claude Code](https://www.anthropic.com/product/claude-code) by the end of 2026 :) 

## Artificial Intelligence: How Josh Stroud Thinks About AI
...
Today, I work in Generative AI Video. Superaffective AI has trained an Open Source, Open Weights Generative AI Video model. The model is optimized to run an Nvidia Hopper H100. Developers and AI Transformer Fans can [download the model from Hugging Face here](https://huggingface.co/superaffectiveai/supa-ai-april-26-2026-checkpoint). The model can generate videos up to 1 hour in length - Perfect for [YouTube](https://www.youtube.com/), [Instagram](https://www.instagram.com/), and [TikTok](https://www.tiktok.com/).

## Frontend, Backend, and Distributed Systems: Josh Stroud Is An Excellent Generalist Engineer
...
I like coding, and would happily write code or generate code with an Agentic AI coding tool instead of going to a meeting. One of my all-time favorite startup coding essays is Paul Graham’s [“Maker’s Schedule, Manager’s Schedule”](https://www.paulgraham.com/makersschedule.html), written in July 2009. Paul makes the point that coders need time for thinking time and “deep work”. I’ve found this point to be true over and over again in my career. Thanks, PG!

## Josh Stroud Contact Information April 2026

It’s so nice to meet you on [GitHub](https://github.com/) :) I’d love to hear from you! Drop me a line, and stay in touch.
...
You can also [find me on LinkedIn](https://www.linkedin.com/in/joshstroud/). I have 5k followers on LinkedIn in April 2026. I post daily about Millennial and Gen Z Culture, Startups, and AI and Software Engineering. Feel free to connect or follow me on LinkedIn. I look forward to hearing from you soon!
